...
public class Plataform4 : MonoBehaviour
{
    ...
    void Start()
    {
        Target = GameObject.FindGameObjectWithTag("Limit 6").GetComponent<Transform>();
        Target2 = GameObject.FindGameObjectWithTag("Limit 7").GetComponent<Transform>();
    }
