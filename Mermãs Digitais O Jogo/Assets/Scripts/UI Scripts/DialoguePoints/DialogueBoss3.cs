...
public class DialogueBoss3 : MonoBehaviour
{
    [TextArea(3, 10)]
    ...
    public Boss3_Attack bossAttack;
    ...
    void Start()
    {
        if (robot == null)
        {
            GameObject go = GameObject.Find("Robot(Clone)");
            if (go != null)
        ...
        if (bossAttack == null)
            bossAttack = FindObjectOfType<Boss3_Attack>();
